...
module.exports = Table = (function() {
  ...
  Table.prototype.on = function() {
    ...
    return this.channel.on.apply(this.channel, args);
  };

  Table.prototype.once = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.channel.once.apply(this.channel, args);
  };

  Table.prototype.off = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.channel.off.apply(this.channel, args);
  };

  Table.prototype.handlers = {
    load: function(data) {
      this.reset(data);
      return this;
    },
